...
const translations = {
  es: {
    ...
    password: 'Contraseña', confirmPassword: 'Confirmar contraseña', repeatPassword: 'Repite tu contraseña', remember: 'Recordarme',
  ...
  en: {
    ...
    password: 'Password', confirmPassword: 'Confirm password', repeatPassword: 'Repeat your password', remember: 'Remember me',
